...
set PATH=C:\msvc2017\lib\native\bin\HostX64\x64;C:\win10sdk\bin\10.0.17134.0\x64;C:\win10sdk\bin\x64;C:\cmake\bin;%PATH%
set Platform=x64
...
set rem WindowsSDK_ExecutablePath_x64=C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\x64\
set rem WindowsSDK_ExecutablePath_x86=C:\Program Files (x86)\Microsoft SDKs\Windows\v10.0A\bin\NETFX 4.6.1 Tools\
